...
import { setDeviceInfoThunk } from '../redux/reducers/DeviceSlice';
...
export default function DeviceInfo() {
  ...
  const { device, status } = useSelector((state) => state.deviceReducer);

  React.useEffect(() => {
    dispatch(setDeviceInfoThunk(params.id));
  }, []);
